...
const Footer = () => {
  return (
    <div className='flex flex-col items-center gap-16 px-0 py-12 test-1'>
      <div className='flex flex-col items-start gap-8 px-8 py-0 test-2'>
        <div className='flex flex-row justify-between px-0 pt-8 pb-0 gap-[360px] test-3 border-t border-gray-200'>
